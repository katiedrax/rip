...
However, data sharing is not an inherent good and the costs and benefits of sharing data for producers and consumers depend on factors from the type of data to standards of ethics, intellectual property, and interoperability.

* Bezuidenhout pg 41 = getting buy-in from researchers
* 4 critiques -https://blogs.lse.ac.uk/impactofsocialsciences/2013/11/27/four-critiques-of-open-data-initiatives/

For example, data sharing will unfairly  if researchers who share their data are less likely to 

Despite the clear benefits of open data for future research, journals are reluctant to mandate data sharing.
In study of 700 journals existing in 2018 @kim2020 only 13.8% mandated data sharing.
Structural barriers discourage data sharing.
Researchers' number of publications, citations, and the impact factor of the journals they publish in affect researchers' opportunities for employment, promotion, and prizes.
This follows from research performance based funding systems, such as the UK's Research Excellence Framework, which use publication counts, journal impact factors, and citations to inform their assessments [@europeancommission.jointresearchcentre.2016]. 
Another structural barrier is the lack of knowledge researchers have for managing and sharing data.
